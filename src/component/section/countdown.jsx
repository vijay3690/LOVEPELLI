...
// Countdown constants moved from sectionConstants.js
const countdownDefaultDate = '11/09/2022';
const countdownNumbersToAddZeroTo = [1, 2, 3, 4, 5, 6, 7, 8, 9];

const CountDown = () => {
    const [countdownDate, setCountdownDate] = useState(new Date(countdownDefaultDate).getTime());
    ...
    const setNewTime = () => {
        ...
        const numbersToAddZeroTo = countdownNumbersToAddZeroTo;
        days = `${days}`;
